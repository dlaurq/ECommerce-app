...
export default function CartProduct({cartProduct}: {cartProduct: CartProduct}) { 
    ...
    return (
        <section className="p-5 flex flex-row justify-start items-start gap-5 border-b-2  border-black">
            <Image 
            ...
            <section className="w-full flex flex-col ">
                <section className="flex flex-row justify-between items-start">
                    ...
                    <section>{cartProduct.products.price * cartProduct.quantity!}$</section>
                </section>
